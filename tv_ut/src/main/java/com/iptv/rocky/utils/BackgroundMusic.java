...
public class BackgroundMusic {
	...
	public void playBackgroundMusic(String path, boolean isLoop) {
		...
		if (mBackgroundMediaPlayer == null) {
			LogUtils.debug("playBackgroundMusic: background media player is null");
		} else {
			...
			try {
				...
				LogUtils.debug("playBackgroundMusic: error state");
			}
		}
	}
	...
	public void rewindBackgroundMusic() {
		if (mBackgroundMediaPlayer != null) {
			...
			try {
				...
				LogUtils.debug("rewindBackgroundMusic: error state");
			}
		}
	}
