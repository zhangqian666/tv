...
public abstract class LiveBaseMetroView extends RelativeLayout {
	...
	public LiveBaseMetroView(Context context) {
		this(context, null, 0);
	}
	
	public LiveBaseMetroView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public LiveBaseMetroView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected RelativeLayout.LayoutParams setItemPosition(BaseMetroItemData itemData) {
		...
		int height = (int)(itemData.heightSpan * ScreenUtils.getLiveItemHeight());
	...
	protected RelativeLayout.LayoutParams setBorderPosition(BaseMetroItemData itemData) {
		...
		int h = (int)(itemData.heightSpan * ScreenUtils.getLiveItemHeight());
