...
public abstract class VodMovieListBaseMetroView extends RelativeLayout {
	...
	public VodMovieListBaseMetroView(Context context) {
		this(context, null, 0);
	}
	
	public VodMovieListBaseMetroView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public VodMovieListBaseMetroView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected RelativeLayout.LayoutParams setBorderPosition(BaseMetroItemData itemData) {
		...
		int w = (int)(itemData.widthSpan * ScreenUtils.getLiveItemWidth() * 1.4);
