...
public abstract class RecChanBaseListItemView extends LinearLayout {
	...
	public RecChanBaseListItemView(Context context) {
		this(context, null, 0);
	}
	
	public RecChanBaseListItemView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public RecChanBaseListItemView(Context context, AttributeSet attrs, int defStyle) {
