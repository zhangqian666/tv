...
public class LiveMetroItemView extends FrameLayout
    ...
    public LiveMetroItemView(Context context) {
		this(context, null, 0);
	}
	
	public LiveMetroItemView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public LiveMetroItemView(Context context, AttributeSet attrs, int defStyle) {
