...
public abstract class AbsSpinner extends AdapterView<SpinnerAdapter> {
    ...
    public AbsSpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.TvAbsSpinner, defStyle, 0);

        CharSequence[] entries = a.getTextArray(R.styleable.TvAbsSpinner_entries);
        if (entries != null) {
            ArrayAdapter<CharSequence> adapter =
                    new ArrayAdapter<CharSequence>(context,
                            R.layout.tv_simple_spinner_item, entries);
            adapter.setDropDownViewResource(R.layout.tv_simple_spinner_dropdown_item);
            setAdapter(adapter);
        }
