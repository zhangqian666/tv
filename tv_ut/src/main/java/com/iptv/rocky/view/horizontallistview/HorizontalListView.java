...
public class HorizontalListView extends AbsHorizontalListView {
        ...
        private ArrayList<FixedViewInfo> mHeaderViewInfos = new ArrayList<HorizontalListView.FixedViewInfo>();
        private ArrayList<FixedViewInfo> mFooterViewInfos = new ArrayList<HorizontalListView.FixedViewInfo>();
...
//                        measureWithChild = array.getInteger( 7 /*R.styleable.HListView_measureWithChild*/, -1 );
                        ...
                        overscrollHeader = array.getDrawable( R.styleable.HListView_overScrollHeader );
                        overscrollFooter = array.getDrawable( R.styleable.HListView_overScrollFooter);
                        dividerWidth = array.getDimensionPixelSize( R.styleable.HListView_dividerWidth, 0 );
                        headerDividersEnabled = array.getBoolean( R.styleable.HListView_headerDividersEnabled, true );
                        footerDividersEnabled = array.getBoolean( R.styleable.HListView_footerDividersEnabled, true );
                        measureWithChild = array.getInteger( R.styleable.HListView_measureWithChild, -1 );
                        array.recycle();
                }
         ...
         * 
         * @param adapter
         *           The HistoryAdapter which is responsible for maintaining the data backing this list and for producing a view to
        ...
        private void measureScrapChildWidth( View child, int position, int heightMeasureSpec ) {
                ...
                if ( p == null ) {
                        p = (AbsHorizontalListView.LayoutParams) generateDefaultLayoutParams();
        ...
        private void setupChild( View child, int position, int x, boolean flowDown, int childrenTop, boolean selected, boolean recycled ) {
                ...
                AbsHorizontalListView.LayoutParams p = (AbsHorizontalListView.LayoutParams) child.getLayoutParams();
                if ( p == null ) {
                        p = (AbsHorizontalListView.LayoutParams) generateDefaultLayoutParams();
                }
                p.viewType = mAdapter.getItemViewType( position );
                ...
                if( android.os.Build.VERSION.SDK_INT >= 11 ) {
                        if ( recycled && ( ( (AbsHorizontalListView.LayoutParams) child.getLayoutParams() ).scrappedFromPosition ) != position ) {
...
//                }
        ...
        private int amountToScroll( int direction, int nextSelectedPosition ) {
                int listRight = getWidth(); //- mListPadding.right;
                ...
                //last item
                if (nextSelectedPosition + 1 == mAdapter.getCount()) {
                	listRight -= mListPadding.right;
                }
        ...
        private void scrollListItemsBy( int amount ) {
                ...
                if ( amount < 0 ) {
                        ...
                        //last item
                        if (mSelectedPosition + 1 == mAdapter.getCount()) {
                        	listRight -= mListPadding.right;
                        }
                        ...
                        while ( first.getRight() < listLeft ) {
                                AbsHorizontalListView.LayoutParams layoutParams = (LayoutParams) first.getLayoutParams();
                        ...
                        while ( last.getLeft() > listRight ) {
                                AbsHorizontalListView.LayoutParams layoutParams = (LayoutParams) last.getLayoutParams();
                                if ( recycleBin.shouldRecycleViewType( layoutParams.viewType ) ) {
        ...
        /**
         * Indicates that the views created by the HistoryAdapter can contain focusable items.
         * 
         * @param itemsCanFocus
        ...
        /**
         * @return Whether the views created by the HistoryAdapter can contain focusable items.
         */
