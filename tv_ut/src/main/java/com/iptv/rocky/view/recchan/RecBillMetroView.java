...
import com.iptv.rocky.base.RecBillListBaseMetroView;
import com.iptv.rocky.model.TvApplication;

public class RecBillMetroView extends RecBillListBaseMetroView {
	
	public RecBillMetroView(Context context) {
		this(context, null, 0);
	}
	
	public RecBillMetroView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public RecBillMetroView(Context context, AttributeSet attrs, int defStyle) {
