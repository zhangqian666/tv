...
import com.iptv.rocky.base.LiveBaseMetroView;
import com.iptv.rocky.model.TvApplication;
import com.iptv.rocky.model.live.LiveTypeItemData;

public class LiveTypeMetroView extends LiveBaseMetroView {
	
	public LiveTypeMetroView(Context context) {
		this(context, null, 0);
	}
	
	public LiveTypeMetroView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public LiveTypeMetroView(Context context, AttributeSet attrs, int defStyle) {
