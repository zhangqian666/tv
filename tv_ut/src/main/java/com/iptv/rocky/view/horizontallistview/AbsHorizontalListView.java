...
import com.iptv.rocky.view.horizontallistview.ViewHelperFactory.ViewHelper;
...
public abstract class AbsHorizontalListView extends AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
...
//			choiceMode = array.getInt( 4 /*R.styleable.AbsHListView_android_choiceMode*/, ListView.CHOICE_MODE_NONE );
			...
			stackFromRight = array.getBoolean( R.styleable.AbsHListView_stackFromRight, false );
			scrollingCacheEnabled = array.getBoolean( R.styleable.AbsHListView_android_scrollingCache, true );
			transcriptMode = array.getInt(R.styleable.AbsHListView_transcriptMode, TRANSCRIPT_MODE_DISABLED );
...
//	}
	...
	static class SavedState extends BaseSavedState {
		...
		/**
		 * Constructor called from {@link AbsHorizontalListView#onSaveInstanceState()}
		 */
...
//			}
	...
	private class FlingRunnable implements Runnable {
		 ...
		 */
		private final com.iptv.rocky.view.horizontallistview.OverScroller mScroller;
	...
	protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
		return new AbsHorizontalListView.LayoutParams( ViewGroup.LayoutParams.WRAP_CONTENT,
	...
	public class RecycleBin {
		...
		public void addScrapView( View scrap, int position ) {
			...
			final boolean scrapHasTransientState = false; //android.os.Build.VERSION.SDK_INT >= 16 ? scrap.hasTransientState() : false;
		...
		public void scrapActiveViews() {
			...
			for ( int i = count - 1; i >= 0; i-- ) {
				...
				if ( victim != null ) {
					final AbsHorizontalListView.LayoutParams lp = (AbsHorizontalListView.LayoutParams) victim.getLayoutParams();
					int whichScrap = lp.viewType;

					activeViews[i] = null;

					final boolean scrapHasTransientState = false; //android.os.Build.VERSION.SDK_INT >= 16 ? victim.hasTransientState() : false;
