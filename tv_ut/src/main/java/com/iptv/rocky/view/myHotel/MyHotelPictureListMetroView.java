...
import com.iptv.rocky.base.MyHotelPictureListBaseMetroView;
import com.iptv.rocky.base.VodMovieListBaseMetroView;
import com.iptv.rocky.model.TvApplication;

public class MyHotelPictureListMetroView extends MyHotelPictureListBaseMetroView {
	
	public MyHotelPictureListMetroView(Context context) {
		this(context, null, 0);
	}
	
	public MyHotelPictureListMetroView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public MyHotelPictureListMetroView(Context context, AttributeSet attrs, int defStyle) {
