 ...
 * limitations under the License.
 */
package com.iptv.rocky.view.gridview;
...
//	private static final int INVALID_POINTER = -1;
	...
	public TwoWayAbsListView(Context context, AttributeSet attrs, int defStyle) {
		...
		int transcriptMode = a.getInt(R.styleable.TwoWayAbsListView_transcriptMode2,
...
//		int saveCount = 0;
	 ...
	 *        in the recycler.
	 *
	 * @see com.iptv.rocky.view.gridview.jess.ui.TwoWayAbsListView.RecycleBin
	 * @see com.iptv.rocky.view.gridview.jess.ui.TwoWayAbsListView.RecyclerListener
	 */
	 ...
	 *
	 * @see com.iptv.rocky.view.gridview.jess.ui.TwoWayAbsListView.RecycleBin
	 * @see com.iptv.rocky.view.gridview.jess.ui.TwoWayAbsListView#setRecyclerListener(com.iptv.rocky.view.gridview.jess.ui.TwoWayAbsListView.RecyclerListener)
	 */
	...
	abstract class TouchHandler {
		...
		/**
		 * Fires an "on scroll state changed" event to the registered
		 * {@link com.iptv.rocky.view.gridview.jess.ui.TwoWayAbsListView.OnScrollListener}, if any. The state change
		 * is fired only if the specified state is different from the previously known state.
		 *
		 * @param newState The new scroll state.
		 */
