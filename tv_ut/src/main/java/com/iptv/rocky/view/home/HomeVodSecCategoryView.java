...
public class HomeVodSecCategoryView extends RelativeLayout 
...
//	private AsyncImageView mIconView;
	private HomeVodSecCategoryData mItemData;
	
	public HomeVodSecCategoryView(Context context) {
		this(context, null, 0);
	}
	
	public HomeVodSecCategoryView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public HomeVodSecCategoryView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}
	
	public void initView(HomeVodSecCategoryData data) {
