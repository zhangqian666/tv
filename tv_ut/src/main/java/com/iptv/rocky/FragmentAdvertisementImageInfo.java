 ...
 *
 */
public class FragmentAdvertisementImageInfo extends Fragment{

	private AdvertisementImageInfo info;
	private int size;
	private int index;
	...
	public FragmentAdvertisementImageInfo(){

	}

	@SuppressLint("ValidFragment")
	public FragmentAdvertisementImageInfo(AdvertisementImageInfo info,int size,int index) {
		this.size=size;
		this.index = index;
		this.info = info;
	}
